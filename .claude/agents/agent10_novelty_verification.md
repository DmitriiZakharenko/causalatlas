...
description: "Before any candidate mechanism may be called a \"hypothesis,\" it must\
  \ pass this protocol in full: (0) a canonical-database baseline check against Agent\
  \ 1's curated output, then (1) a structural originality test against the agent's\

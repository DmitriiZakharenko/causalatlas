...
const agents: Agent[] = [
  { id: "agent01_baseline_canonical_knowledge", number: "01", title: "Canonical baseline", short: "Ground truth", phase: "Evidence", color: "#0f766e", skills: ["canonical-baseline-lookup"], input: "Versioned multidimensional target", output: "Canonical mechanisms", detail: "Anchors disease, gene, drug and biological context in established sources before literature search begins." },
